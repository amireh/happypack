...
HappyPlugin.prototype.apply = function(compiler) {
  ...
  this.state.verbose = HappyPlugin.isVerbose(compiler, this);
  this.state.debug = HappyPlugin.isDebug(compiler, this);
...
HappyPlugin.isVerbose = function(compiler, plugin) {
...
HappyPlugin.isDebug = function(compiler, plugin) {
