...
function HappyPlugin(config) {
  ...
  this.config.cachePath = String(config.cachePath || '.happypack/cache.json');
  ...
  this.cache = HappyFSCache(this.config.cachePath, this.config.transformer);
  ...
  if (this.config.cache) {
    console.log('HappyPack: will be using the cache.');
    this.cache.load();
  }
