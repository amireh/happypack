...
module.exports = function HappyFSCache(id, cachePath, transformer) {
  var exports = {};
  var cache = {
  ...
  exports.load = function() {
    if (Utils.isReadable(cachePath)) {
      ...
      if (cache.transformer !== transformer) {
      ...
      console.log('Happy[%s]: Loaded %d entries from cache.', id, Object.keys(cache.mtimes).length);
    }
  };
